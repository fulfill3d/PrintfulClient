...
namespace Client.Models
{
    public class SyncVariantFile
    {
        ...
        // string or null
        // Stitch count tier
        // see https://help.printful.com/hc/en-us/articles/4909652626204-What-s-the-new-large-embroidery-pricing-
        [JsonProperty("stitch_count_tier")]
        public string? StitchCountTier { get; set; }
